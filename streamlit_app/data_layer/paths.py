...
class Paths:
    ...
    balanced_csv: str = "../data/processed/balanced_metrics.csv"
    baseline_csv: str = "../data/processed/balanced_metrics.csv"
    fraud_cases_csv: str = "../data/processed/fraud_cases.csv"
    final_summary_csv: str = "../data/processed/final_summary.csv"
    threshold_summary_csv: str = "../data/processed/threshold_summary.csv"
    feature_importance_logred_csv: str = "../data/processed/feature_importance_logred.csv" 
